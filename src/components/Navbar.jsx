    ...
    <Disclosure as="nav" className="sticky top-0 bg-black z-10 w-full">
      <div className="mx-auto max-w-8xl  px-2 sm:px-6 lg:px-8">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="flex flex-1 items-center sm:items-stretch sm:justify-between ml-2 sm:ml-0">
            <a href="/">
              <div className="flex shrink-0 items-end gap-2 ">
                <p className="text-white text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold">
                  PortFolio
                </p>
