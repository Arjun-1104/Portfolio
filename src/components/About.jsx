...
const About = () => {
  ...
  const { preName, name, occupation, description, shortLine, resumeTitle } =
    aboutData;
  return (
    <div id="about" className="px-4 md:px-7 sm:flex mt-20 scroll-mt-40">
      <div className="sm:w-1/2 tracking-widest flex flex-col space-y-3">
        <h3 className="text-gray-400 text-base font-semibold tracking-widerest">
          {preName}
        </h3>
        <p className="text-6xl text-white font-semibold tracking-wider whitespace-pre-line">
          {name}
        </p>
        <h2 className="text-[#c5ba22] text-4xl whitespace-pre-line">
          {occupation}
        </h2>
